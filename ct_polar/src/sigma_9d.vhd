...
entity sigma_9d is
  port (
    ...
    vz_mean         : in  signed(47 downto 0);
    az_mean         : in  signed(47 downto 0);
...
architecture Behavioral of sigma_9d is
  ...
  signal px_r, py_r, v_r, theta_r, omega_r, a_r, z_r, vz_r, az_r : signed(47 downto 0);
  ...
  signal l81_r, l82_r, l83_r, l84_r, l85_r, l86_r, l87_r, l88_r : signed(47 downto 0);
  signal l91_r, l92_r, l93_r, l94_r, l95_r, l96_r, l97_r, l98_r, l99_r : signed(47 downto 0);
      ...
      if rst = '1' then
        ...
        case state is
          ...
          when LATCH_INPUTS =>
            ...
            a_r <= a_mean; z_r <= z_mean; vz_r <= vz_mean; az_r <= az_mean;
            ...
            l81_r <= l81; l82_r <= l82; l83_r <= l83; l84_r <= l84; l85_r <= l85; l86_r <= l86; l87_r <= l87; l88_r <= l88;
            l91_r <= l91; l92_r <= l92; l93_r <= l93; l94_r <= l94; l95_r <= l95; l96_r <= l96; l97_r <= l97; l98_r <= l98; l99_r <= l99;
          ...
          when CALCULATE =>
            ...
            chi0_a <= a_r; chi0_z <= z_r; chi0_vz <= vz_r; chi0_az <= az_r;
            ...
            chi1_vz    <= vz_r    + gamma_scale(l81_r);
            chi1_az    <= az_r    + gamma_scale(l91_r);
            ...
            chi2_vz    <= vz_r    + gamma_scale(l82_r);
            chi2_az    <= az_r    + gamma_scale(l92_r);
            ...
            chi3_vz    <= vz_r    + gamma_scale(l83_r);
            chi3_az    <= az_r    + gamma_scale(l93_r);
            ...
            chi4_vz    <= vz_r    + gamma_scale(l84_r);
            chi4_az    <= az_r    + gamma_scale(l94_r);
            ...
            chi5_vz    <= vz_r    + gamma_scale(l85_r);
            chi5_az    <= az_r    + gamma_scale(l95_r);
            ...
            chi6_vz    <= vz_r    + gamma_scale(l86_r);
            chi6_az    <= az_r    + gamma_scale(l96_r);
            ...
            chi7_vz    <= vz_r    + gamma_scale(l87_r);
            chi7_az    <= az_r    + gamma_scale(l97_r);
            ...
            chi8_a     <= a_r;
            chi8_z     <= z_r;
            chi8_vz    <= vz_r    + gamma_scale(l88_r);
            chi8_az    <= az_r    + gamma_scale(l98_r);
            ...
            chi9_z     <= z_r;
            chi9_vz    <= vz_r;
            chi9_az    <= az_r    + gamma_scale(l99_r);

            chi10_px    <= px_r    - gamma_scale(l11_r);
            chi10_py    <= py_r    - gamma_scale(l21_r);
            chi10_v     <= v_r     - gamma_scale(l31_r);
            chi10_theta <= theta_r - gamma_scale(l41_r);
            chi10_omega <= omega_r - gamma_scale(l51_r);
            chi10_a     <= a_r     - gamma_scale(l61_r);
            chi10_z     <= z_r     - gamma_scale(l71_r);
            chi10_vz    <= vz_r    - gamma_scale(l81_r);
            chi10_az    <= az_r    - gamma_scale(l91_r);

            chi11_px    <= px_r;
            chi11_py    <= py_r    - gamma_scale(l22_r);
            chi11_v     <= v_r     - gamma_scale(l32_r);
            chi11_theta <= theta_r - gamma_scale(l42_r);
            chi11_omega <= omega_r - gamma_scale(l52_r);
            chi11_a     <= a_r     - gamma_scale(l62_r);
            chi11_z     <= z_r     - gamma_scale(l72_r);
            chi11_vz    <= vz_r    - gamma_scale(l82_r);
            chi11_az    <= az_r    - gamma_scale(l92_r);

            chi12_px    <= px_r;
            chi12_py    <= py_r;
            chi12_v     <= v_r     - gamma_scale(l33_r);
            chi12_theta <= theta_r - gamma_scale(l43_r);
            chi12_omega <= omega_r - gamma_scale(l53_r);
            chi12_a     <= a_r     - gamma_scale(l63_r);
            chi12_z     <= z_r     - gamma_scale(l73_r);
            chi12_vz    <= vz_r    - gamma_scale(l83_r);
            chi12_az    <= az_r    - gamma_scale(l93_r);

            chi13_px    <= px_r;
            chi13_py    <= py_r;
            chi13_v     <= v_r;
            chi13_theta <= theta_r - gamma_scale(l44_r);
            chi13_omega <= omega_r - gamma_scale(l54_r);
            chi13_a     <= a_r     - gamma_scale(l64_r);
            chi13_z     <= z_r     - gamma_scale(l74_r);
            chi13_vz    <= vz_r    - gamma_scale(l84_r);
            chi13_az    <= az_r    - gamma_scale(l94_r);

            chi14_px    <= px_r;
            chi14_py    <= py_r;
            chi14_v     <= v_r;
            chi14_theta <= theta_r;
            chi14_omega <= omega_r - gamma_scale(l55_r);
            chi14_a     <= a_r     - gamma_scale(l65_r);
            chi14_z     <= z_r     - gamma_scale(l75_r);
            chi14_vz    <= vz_r    - gamma_scale(l85_r);
            chi14_az    <= az_r    - gamma_scale(l95_r);
            ...
            chi15_theta <= theta_r;
            chi15_omega <= omega_r;
            chi15_a     <= a_r     - gamma_scale(l66_r);
            chi15_z     <= z_r     - gamma_scale(l76_r);
            chi15_vz    <= vz_r    - gamma_scale(l86_r);
            chi15_az    <= az_r    - gamma_scale(l96_r);
            ...
            chi16_omega <= omega_r;
            chi16_a     <= a_r;
            chi16_z     <= z_r     - gamma_scale(l77_r);
            chi16_vz    <= vz_r    - gamma_scale(l87_r);
            chi16_az    <= az_r    - gamma_scale(l97_r);
            ...
            chi17_a     <= a_r;
            chi17_z     <= z_r;
            chi17_vz    <= vz_r    - gamma_scale(l88_r);
            chi17_az    <= az_r    - gamma_scale(l98_r);
            ...
            chi18_z     <= z_r;
            chi18_vz    <= vz_r;
            chi18_az    <= az_r    - gamma_scale(l99_r);
