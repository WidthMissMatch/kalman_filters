...
entity innovation_covariance_9d is
    port (
        clk   : in  std_logic;
        start : in  std_logic;
...
end innovation_covariance_9d;

architecture Behavioral of innovation_covariance_9d is

    constant W0 : signed(47 downto 0) := to_signed(33554432, 48);
    constant W1 : signed(47 downto 0) := to_signed(932068, 48);
    constant Q  : integer := 24;

    constant R11_Q24 : signed(47 downto 0) := to_signed(33554432, 48);
    constant R22_Q24 : signed(47 downto 0) := to_signed(33554432, 48);
    constant R33_Q24 : signed(47 downto 0) := to_signed(33554432, 48);
    ...
    constant WEIGHTS : weight_array := (W0, W1, W1, W1, W1, W1, W1, W1, W1, W1,
