...
entity singer_measurement_update_imm is
    port (
        clk   : in  std_logic;
        start : in  std_logic;
...
end singer_measurement_update_imm;
architecture Behavioral of singer_measurement_update_imm is
    ...
    begin
        if rising_edge(clk) then
            case state is
                ...
                when FINISHED =>
                    report "MEASUREMENT_UPDATE: FINISHED state";
                    done <= '1';
                    if start = '0' then
