...
rm -rf xsim.dir
rm -f *.jou *.log *.pb xelab.* xvhdl.* webtalk* *.wdb
rm -f vhdl_output_synthetic_drone_500cycles.txt

# Compile in order (dependencies first)
/home/arunupscee/vivado/2025.1/Vivado/bin/xvhdl --work work src/sqrt_cordic.vhd
...
/home/arunupscee/vivado/2025.1/Vivado/bin/xvhdl --work work src/state_update_3d.vhd
