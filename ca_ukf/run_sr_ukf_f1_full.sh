...
echo "=== Compiling CA SR-UKF F1 ${TRACK} (full) ==="
...
echo "=== Elaborating ==="
$XELAB -debug typical work.sr_ukf_ca_f1_${TRACK}_2024_tb -s sr_f1_full

echo "=== Running ==="
$XSIM sr_f1_full --runall

echo "=========================================="
echo "CA SR-UKF F1 ${TRACK} DONE"
echo "=========================================="
