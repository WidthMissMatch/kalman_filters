...
entity sr_measurement_update_ca_3d is
    port (
        clk   : in  std_logic;
        reset : in  std_logic;
        start : in  std_logic;
...
end sr_measurement_update_ca_3d;

architecture Behavioral of sr_measurement_update_ca_3d is
                ...
                case state is
                    ...
                    when FINISHED =>
                        report "SR_MEASUREMENT_UPDATE: FINISHED state" & LF &
                               ...
                               "  These are passed through to sr_ukf_supreme_ca_3d";
                        done <= '1';
                        if start = '0' then
