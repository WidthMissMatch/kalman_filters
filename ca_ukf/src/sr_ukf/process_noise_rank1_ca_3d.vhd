...
architecture Behavioral of process_noise_rank1_ca_3d is
    ...
    constant LQ_POS : signed(47 downto 0) := to_signed(83886080, 48);
    constant LQ_VEL : signed(47 downto 0) := to_signed(53054215, 48);
    constant LQ_ACC : signed(47 downto 0) := to_signed(118632832, 48);
