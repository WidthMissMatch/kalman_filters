...
architecture Behavioral of kalman_gain_7d is
  ...
  component matrix_inverse_3x3 is
    port (
      ...
      start   : in  std_logic;
      s11, s12, s22, s13, s23, s33 : in signed(47 downto 0);
      s_inv_11, s_inv_12, s_inv_22, s_inv_13, s_inv_23, s_inv_33 : out signed(47 downto 0);
  ...
  signal pxz_r : signed(47 downto 0);

  type k_int_array is array(1 to 7, 1 to 3) of signed(95 downto 0);
...
begin
  ...
  inv_inst : matrix_inverse_3x3
    port map (
      ...
      s_inv_11 => sinv_11, s_inv_12 => sinv_12, s_inv_22 => sinv_22,
      s_inv_13 => sinv_13, s_inv_23 => sinv_23, s_inv_33 => sinv_33,
