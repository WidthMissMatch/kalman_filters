...
entity process_noise_bicycle is
  port (
    clk   : in  std_logic;
    rst   : in  std_logic;
    start : in  std_logic;
...
architecture Behavioral of process_noise_bicycle is
  ...
  constant Q_DELTA : signed(47 downto 0) := to_signed(16777, 48);
