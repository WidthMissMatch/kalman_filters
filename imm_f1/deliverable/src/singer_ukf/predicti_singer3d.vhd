        ...
        case state is
          ...
          when IDLE =>
            ...
            if start = '1' then
              ...
              if 0 >= 1 and 0 <= 2 then
                report "PREDICTI[0]: IDLE - Input sigma points (values hex-suppressed)";
              end if;
          ...
          when WAIT_EXP =>
            ...
            if exp_done = '1' then
              ...
              if 0 >= 1 and 0 <= 2 then
                report "PREDICTI[0]: WAIT_EXP - Singer terms computed (values hex-suppressed)";
              end if;
          ...
          when CALCULATE =>
            ...
            if 0 >= 1 and 0 <= 2 then
              report "PREDICTI[0]: CALCULATE - Checking computations (values hex-suppressed)";
              report "PREDICTI[0]: CALCULATE - Output values (values hex-suppressed)";
            end if;
