...
end ca_ukf_supreme_imm;
architecture Behavioral of ca_ukf_supreme_imm is
    ...
    component ca_measurement_update_imm is
        port (
...
begin
    ...
    measurement_update_inst : ca_measurement_update_imm
        port map (
            clk => clk,
            start => update_start,
        ...
        if rising_edge(clk) then
            if reset = '1' then
                ...
                case state is
                    ...
                    when RUN_PREDICTION =>
                        report "UKF_SUPREME: RUN_PREDICTION (starting prediction, values hex-suppressed)";
                        pred_start <= '1';
