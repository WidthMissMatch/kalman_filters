...
entity prediction_phase_p_3d is
    port (
        clk   : in  std_logic;
        rst   : in  std_logic;
        start : in  std_logic;
...
end prediction_phase_p_3d;
architecture Behavioral of prediction_phase_p_3d is
    ...
    component process_noise_singer_p_3d is
        port (
            clk : in std_logic; start : in std_logic;
...
begin
    ...
    noise_comp : process_noise_singer_p_3d
        port map (
            ...
            case state is
                ...
                when WAIT_CHOLESKY =>
                    ...
                    if cholesky_done = '1' then
                        if cholesky_error = '1' then
                            report "ERROR: Cholesky PSD failure - skipping prediction" severity warning;
                            state <= FINISHED;
                        else
                            state <= RUN_SIGMA;
                        end if;
                ...
                when WAIT_NOISE =>
                    ...
                    if noise_done = '1' then
                        ...
                        chi_pred_0_x_pos <= chi_pred_int_0_x_pos; chi_pred_0_x_vel <= chi_pred_int_0_x_vel; chi_pred_0_x_acc <= chi_pred_int_0_x_acc;
                        chi_pred_0_y_pos <= chi_pred_int_0_y_pos; chi_pred_0_y_vel <= chi_pred_int_0_y_vel; chi_pred_0_y_acc <= chi_pred_int_0_y_acc;
                        chi_pred_0_z_pos <= chi_pred_int_0_z_pos; chi_pred_0_z_vel <= chi_pred_int_0_z_vel; chi_pred_0_z_acc <= chi_pred_int_0_z_acc;

                        chi_pred_1_x_pos <= chi_pred_int_1_x_pos; chi_pred_1_x_vel <= chi_pred_int_1_x_vel; chi_pred_1_x_acc <= chi_pred_int_1_x_acc;
                        chi_pred_1_y_pos <= chi_pred_int_1_y_pos; chi_pred_1_y_vel <= chi_pred_int_1_y_vel; chi_pred_1_y_acc <= chi_pred_int_1_y_acc;
                        chi_pred_1_z_pos <= chi_pred_int_1_z_pos; chi_pred_1_z_vel <= chi_pred_int_1_z_vel; chi_pred_1_z_acc <= chi_pred_int_1_z_acc;

                        chi_pred_2_x_pos <= chi_pred_int_2_x_pos; chi_pred_2_x_vel <= chi_pred_int_2_x_vel; chi_pred_2_x_acc <= chi_pred_int_2_x_acc;
                        chi_pred_2_y_pos <= chi_pred_int_2_y_pos; chi_pred_2_y_vel <= chi_pred_int_2_y_vel; chi_pred_2_y_acc <= chi_pred_int_2_y_acc;
                        chi_pred_2_z_pos <= chi_pred_int_2_z_pos; chi_pred_2_z_vel <= chi_pred_int_2_z_vel; chi_pred_2_z_acc <= chi_pred_int_2_z_acc;

                        chi_pred_3_x_pos <= chi_pred_int_3_x_pos; chi_pred_3_x_vel <= chi_pred_int_3_x_vel; chi_pred_3_x_acc <= chi_pred_int_3_x_acc;
                        chi_pred_3_y_pos <= chi_pred_int_3_y_pos; chi_pred_3_y_vel <= chi_pred_int_3_y_vel; chi_pred_3_y_acc <= chi_pred_int_3_y_acc;
                        chi_pred_3_z_pos <= chi_pred_int_3_z_pos; chi_pred_3_z_vel <= chi_pred_int_3_z_vel; chi_pred_3_z_acc <= chi_pred_int_3_z_acc;

                        chi_pred_4_x_pos <= chi_pred_int_4_x_pos; chi_pred_4_x_vel <= chi_pred_int_4_x_vel; chi_pred_4_x_acc <= chi_pred_int_4_x_acc;
                        chi_pred_4_y_pos <= chi_pred_int_4_y_pos; chi_pred_4_y_vel <= chi_pred_int_4_y_vel; chi_pred_4_y_acc <= chi_pred_int_4_y_acc;
                        chi_pred_4_z_pos <= chi_pred_int_4_z_pos; chi_pred_4_z_vel <= chi_pred_int_4_z_vel; chi_pred_4_z_acc <= chi_pred_int_4_z_acc;

                        chi_pred_5_x_pos <= chi_pred_int_5_x_pos; chi_pred_5_x_vel <= chi_pred_int_5_x_vel; chi_pred_5_x_acc <= chi_pred_int_5_x_acc;
                        chi_pred_5_y_pos <= chi_pred_int_5_y_pos; chi_pred_5_y_vel <= chi_pred_int_5_y_vel; chi_pred_5_y_acc <= chi_pred_int_5_y_acc;
                        chi_pred_5_z_pos <= chi_pred_int_5_z_pos; chi_pred_5_z_vel <= chi_pred_int_5_z_vel; chi_pred_5_z_acc <= chi_pred_int_5_z_acc;

                        chi_pred_6_x_pos <= chi_pred_int_6_x_pos; chi_pred_6_x_vel <= chi_pred_int_6_x_vel; chi_pred_6_x_acc <= chi_pred_int_6_x_acc;
                        chi_pred_6_y_pos <= chi_pred_int_6_y_pos; chi_pred_6_y_vel <= chi_pred_int_6_y_vel; chi_pred_6_y_acc <= chi_pred_int_6_y_acc;
                        chi_pred_6_z_pos <= chi_pred_int_6_z_pos; chi_pred_6_z_vel <= chi_pred_int_6_z_vel; chi_pred_6_z_acc <= chi_pred_int_6_z_acc;

                        chi_pred_7_x_pos <= chi_pred_int_7_x_pos; chi_pred_7_x_vel <= chi_pred_int_7_x_vel; chi_pred_7_x_acc <= chi_pred_int_7_x_acc;
                        chi_pred_7_y_pos <= chi_pred_int_7_y_pos; chi_pred_7_y_vel <= chi_pred_int_7_y_vel; chi_pred_7_y_acc <= chi_pred_int_7_y_acc;
                        chi_pred_7_z_pos <= chi_pred_int_7_z_pos; chi_pred_7_z_vel <= chi_pred_int_7_z_vel; chi_pred_7_z_acc <= chi_pred_int_7_z_acc;

                        chi_pred_8_x_pos <= chi_pred_int_8_x_pos; chi_pred_8_x_vel <= chi_pred_int_8_x_vel; chi_pred_8_x_acc <= chi_pred_int_8_x_acc;
                        chi_pred_8_y_pos <= chi_pred_int_8_y_pos; chi_pred_8_y_vel <= chi_pred_int_8_y_vel; chi_pred_8_y_acc <= chi_pred_int_8_y_acc;
                        chi_pred_8_z_pos <= chi_pred_int_8_z_pos; chi_pred_8_z_vel <= chi_pred_int_8_z_vel; chi_pred_8_z_acc <= chi_pred_int_8_z_acc;

                        chi_pred_9_x_pos <= chi_pred_int_9_x_pos; chi_pred_9_x_vel <= chi_pred_int_9_x_vel; chi_pred_9_x_acc <= chi_pred_int_9_x_acc;
                        chi_pred_9_y_pos <= chi_pred_int_9_y_pos; chi_pred_9_y_vel <= chi_pred_int_9_y_vel; chi_pred_9_y_acc <= chi_pred_int_9_y_acc;
                        chi_pred_9_z_pos <= chi_pred_int_9_z_pos; chi_pred_9_z_vel <= chi_pred_int_9_z_vel; chi_pred_9_z_acc <= chi_pred_int_9_z_acc;

                        chi_pred_10_x_pos <= chi_pred_int_10_x_pos; chi_pred_10_x_vel <= chi_pred_int_10_x_vel; chi_pred_10_x_acc <= chi_pred_int_10_x_acc;
                        chi_pred_10_y_pos <= chi_pred_int_10_y_pos; chi_pred_10_y_vel <= chi_pred_int_10_y_vel; chi_pred_10_y_acc <= chi_pred_int_10_y_acc;
                        chi_pred_10_z_pos <= chi_pred_int_10_z_pos; chi_pred_10_z_vel <= chi_pred_int_10_z_vel; chi_pred_10_z_acc <= chi_pred_int_10_z_acc;

                        chi_pred_11_x_pos <= chi_pred_int_11_x_pos; chi_pred_11_x_vel <= chi_pred_int_11_x_vel; chi_pred_11_x_acc <= chi_pred_int_11_x_acc;
                        chi_pred_11_y_pos <= chi_pred_int_11_y_pos; chi_pred_11_y_vel <= chi_pred_int_11_y_vel; chi_pred_11_y_acc <= chi_pred_int_11_y_acc;
                        chi_pred_11_z_pos <= chi_pred_int_11_z_pos; chi_pred_11_z_vel <= chi_pred_int_11_z_vel; chi_pred_11_z_acc <= chi_pred_int_11_z_acc;

                        chi_pred_12_x_pos <= chi_pred_int_12_x_pos; chi_pred_12_x_vel <= chi_pred_int_12_x_vel; chi_pred_12_x_acc <= chi_pred_int_12_x_acc;
                        chi_pred_12_y_pos <= chi_pred_int_12_y_pos; chi_pred_12_y_vel <= chi_pred_int_12_y_vel; chi_pred_12_y_acc <= chi_pred_int_12_y_acc;
                        chi_pred_12_z_pos <= chi_pred_int_12_z_pos; chi_pred_12_z_vel <= chi_pred_int_12_z_vel; chi_pred_12_z_acc <= chi_pred_int_12_z_acc;

                        chi_pred_13_x_pos <= chi_pred_int_13_x_pos; chi_pred_13_x_vel <= chi_pred_int_13_x_vel; chi_pred_13_x_acc <= chi_pred_int_13_x_acc;
                        chi_pred_13_y_pos <= chi_pred_int_13_y_pos; chi_pred_13_y_vel <= chi_pred_int_13_y_vel; chi_pred_13_y_acc <= chi_pred_int_13_y_acc;
                        chi_pred_13_z_pos <= chi_pred_int_13_z_pos; chi_pred_13_z_vel <= chi_pred_int_13_z_vel; chi_pred_13_z_acc <= chi_pred_int_13_z_acc;

                        chi_pred_14_x_pos <= chi_pred_int_14_x_pos; chi_pred_14_x_vel <= chi_pred_int_14_x_vel; chi_pred_14_x_acc <= chi_pred_int_14_x_acc;
                        chi_pred_14_y_pos <= chi_pred_int_14_y_pos; chi_pred_14_y_vel <= chi_pred_int_14_y_vel; chi_pred_14_y_acc <= chi_pred_int_14_y_acc;
                        chi_pred_14_z_pos <= chi_pred_int_14_z_pos; chi_pred_14_z_vel <= chi_pred_int_14_z_vel; chi_pred_14_z_acc <= chi_pred_int_14_z_acc;

                        chi_pred_15_x_pos <= chi_pred_int_15_x_pos; chi_pred_15_x_vel <= chi_pred_int_15_x_vel; chi_pred_15_x_acc <= chi_pred_int_15_x_acc;
                        chi_pred_15_y_pos <= chi_pred_int_15_y_pos; chi_pred_15_y_vel <= chi_pred_int_15_y_vel; chi_pred_15_y_acc <= chi_pred_int_15_y_acc;
                        chi_pred_15_z_pos <= chi_pred_int_15_z_pos; chi_pred_15_z_vel <= chi_pred_int_15_z_vel; chi_pred_15_z_acc <= chi_pred_int_15_z_acc;

                        chi_pred_16_x_pos <= chi_pred_int_16_x_pos; chi_pred_16_x_vel <= chi_pred_int_16_x_vel; chi_pred_16_x_acc <= chi_pred_int_16_x_acc;
                        chi_pred_16_y_pos <= chi_pred_int_16_y_pos; chi_pred_16_y_vel <= chi_pred_int_16_y_vel; chi_pred_16_y_acc <= chi_pred_int_16_y_acc;
                        chi_pred_16_z_pos <= chi_pred_int_16_z_pos; chi_pred_16_z_vel <= chi_pred_int_16_z_vel; chi_pred_16_z_acc <= chi_pred_int_16_z_acc;

                        chi_pred_17_x_pos <= chi_pred_int_17_x_pos; chi_pred_17_x_vel <= chi_pred_int_17_x_vel; chi_pred_17_x_acc <= chi_pred_int_17_x_acc;
                        chi_pred_17_y_pos <= chi_pred_int_17_y_pos; chi_pred_17_y_vel <= chi_pred_int_17_y_vel; chi_pred_17_y_acc <= chi_pred_int_17_y_acc;
                        chi_pred_17_z_pos <= chi_pred_int_17_z_pos; chi_pred_17_z_vel <= chi_pred_int_17_z_vel; chi_pred_17_z_acc <= chi_pred_int_17_z_acc;

                        chi_pred_18_x_pos <= chi_pred_int_18_x_pos; chi_pred_18_x_vel <= chi_pred_int_18_x_vel; chi_pred_18_x_acc <= chi_pred_int_18_x_acc;
                        chi_pred_18_y_pos <= chi_pred_int_18_y_pos; chi_pred_18_y_vel <= chi_pred_int_18_y_vel; chi_pred_18_y_acc <= chi_pred_int_18_y_acc;
                        chi_pred_18_z_pos <= chi_pred_int_18_z_pos; chi_pred_18_z_vel <= chi_pred_int_18_z_vel; chi_pred_18_z_acc <= chi_pred_int_18_z_acc;
