...
architecture Behavioral of state_update_potter_3d is
    ...
    constant R22_Q24_24 : signed(47 downto 0) := to_signed(8388608, 48);
    constant R33_Q24_24 : signed(47 downto 0) := to_signed(8388608, 48);
            ...
            if reset = '1' then
                ...
                case state is
                    ...
                    when COMPUTE_KR =>
                        ...
                        if cycle_num >= 1 and cycle_num <= 2 then
                            report "POTTER[" & integer'image(cycle_num) & "]: COMPUTE_KR - Computing w vectors for downdates";
                        end if;
