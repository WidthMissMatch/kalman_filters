...
architecture Behavioral of innovation_covariance_3d is
    ...
    type meas_array is array (0 to 12) of signed(47 downto 0);
    ...
    signal sum_s11, sum_s22, sum_s33 : signed(32 downto 0) := (others => '0');
    signal sum_s12, sum_s13, sum_s23 : signed(32 downto 0) := (others => '0');
    ...
    begin
        if rising_edge(clk) then
            case state is
                ...
                when ADD_R =>
                    sum_s11 <= resize(acc_s11, 33) + resize(R11_Q24_24, 33);
                    sum_s22 <= resize(acc_s22, 33) + resize(R22_Q24_24, 33);
                    sum_s33 <= resize(acc_s33, 33) + resize(R33_Q24_24, 33);
                    sum_s12 <= resize(acc_s12, 33);
                    sum_s13 <= resize(acc_s13, 33);
                    sum_s23 <= resize(acc_s23, 33);
                    state <= SATURATE;
                when SATURATE =>
