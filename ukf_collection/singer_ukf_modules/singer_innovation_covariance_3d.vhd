        ...
        if rising_edge(clk) then
            case state is
                ...
                when FINISHED =>
                    ...
                    if to_integer(s11) < 0 or to_integer(s22) < 0 or to_integer(s33) < 0 then
                        report "WARNING: Negative diagonal in S matrix (ill-conditioned)" severity warning;
                    end if;
                    if to_integer(s11) = 0 or to_integer(s22) = 0 or to_integer(s33) = 0 then
                        report "WARNING: Zero diagonal in S matrix (singular)" severity warning;
                    end if;
