...
architecture Behavioral of matrix_inverse_3x3 is
    ...
    constant MIN_DET : signed(47 downto 0) := to_signed(1024, 48);
        ...
        if rising_edge(clk) then
            case state is
                ...
                when COMPUTE_DET =>
                    ...
                    report "MATRIX_INV: COMPUTE_DET (144-bit) - determinant computed";

                    state <= CHECK_SINGULAR;

                when CHECK_SINGULAR =>

                    report "MATRIX_INV: CHECK_SINGULAR - checking singularity (det threshold=" & integer'image(to_integer(MIN_DET)) & ")";
                ...
                when DIVIDE_COFACTORS =>
                    ...
                    report "MATRIX_INV: DIVIDE_COFACTORS (direct division - 1 cycle!)";
