...
architecture Behavioral of state_update_3d is
    ...
    function saturate_covariance(val : signed(143 downto 0)) return signed is
        ...
        if rising_edge(clk) then
            case state is
                ...
                when UPDATE_STATE =>
                    ...
                    temp_sum := resize((k11_reg * nu_x_reg) + (k12_reg * nu_y_reg) + (k13_reg * nu_z_reg), 144);
                    x_pos_upd <= x_pos_pred + resize(shift_right(temp_sum, Q), 48);

                    temp_sum := resize((k21_reg * nu_x_reg) + (k22_reg * nu_y_reg) + (k23_reg * nu_z_reg), 144);
                    x_vel_upd <= x_vel_pred + resize(shift_right(temp_sum, Q), 48);

                    temp_sum := resize((k31_reg * nu_x_reg) + (k32_reg * nu_y_reg) + (k33_reg * nu_z_reg), 144);
                    x_omega_upd <= x_omega_pred + resize(shift_right(temp_sum, Q), 48);

                    temp_sum := resize((k41_reg * nu_x_reg) + (k42_reg * nu_y_reg) + (k43_reg * nu_z_reg), 144);
                    y_pos_upd <= y_pos_pred + resize(shift_right(temp_sum, Q), 48);

                    temp_sum := resize((k51_reg * nu_x_reg) + (k52_reg * nu_y_reg) + (k53_reg * nu_z_reg), 144);
                    y_vel_upd <= y_vel_pred + resize(shift_right(temp_sum, Q), 48);

                    temp_sum := resize((k61_reg * nu_x_reg) + (k62_reg * nu_y_reg) + (k63_reg * nu_z_reg), 144);
                    y_omega_upd <= y_omega_pred + resize(shift_right(temp_sum, Q), 48);

                    temp_sum := resize((k71_reg * nu_x_reg) + (k72_reg * nu_y_reg) + (k73_reg * nu_z_reg), 144);
                    z_pos_upd <= z_pos_pred + resize(shift_right(temp_sum, Q), 48);

                    temp_sum := resize((k81_reg * nu_x_reg) + (k82_reg * nu_y_reg) + (k83_reg * nu_z_reg), 144);
                    z_vel_upd <= z_vel_pred + resize(shift_right(temp_sum, Q), 48);

                    temp_sum := resize((k91_reg * nu_x_reg) + (k92_reg * nu_y_reg) + (k93_reg * nu_z_reg), 144);
                    z_omega_upd <= z_omega_pred + resize(shift_right(temp_sum, Q), 48);
                ...
                when COMPUTE_APAT =>
                    ...
                    apat_11 <= resize(ap(0) * a11, 144) + resize(ap(1) * a12, 144) + resize(ap(2) * a13, 144);

                    apat_12 <= resize(ap(0) * a21, 144) + resize(ap(1) * a22, 144) + resize(ap(2) * a23, 144);

                    apat_13 <= resize(ap(0) * a31, 144) + resize(ap(1) * a32, 144) + resize(ap(2) * a33, 144);

                    apat_14 <= resize(ap(3) * a44, 144) + resize(ap(4) * a45, 144) + resize(ap(5) * a46, 144);

                    apat_15 <= resize(ap(3) * a54, 144) + resize(ap(4) * a55, 144) + resize(ap(5) * a56, 144);

                    apat_16 <= resize(ap(3) * a64, 144) + resize(ap(4) * a65, 144) + resize(ap(5) * a66, 144);

                    apat_17 <= resize(ap(6) * a77, 144) + resize(ap(7) * a78, 144) + resize(ap(8) * a79, 144);

                    apat_18 <= resize(ap(6) * a87, 144) + resize(ap(7) * a88, 144) + resize(ap(8) * a89, 144);

                    apat_19 <= resize(ap(6) * a97, 144) + resize(ap(7) * a98, 144) + resize(ap(8) * a99, 144);

                    apat_22 <= resize(ap(9) * a21, 144) + resize(ap(10) * a22, 144) + resize(ap(11) * a23, 144);

                    apat_23 <= resize(ap(9) * a31, 144) + resize(ap(10) * a32, 144) + resize(ap(11) * a33, 144);

                    apat_24 <= resize(ap(12) * a44, 144) + resize(ap(13) * a45, 144) + resize(ap(14) * a46, 144);

                    apat_25 <= resize(ap(12) * a54, 144) + resize(ap(13) * a55, 144) + resize(ap(14) * a56, 144);

                    apat_26 <= resize(ap(12) * a64, 144) + resize(ap(13) * a65, 144) + resize(ap(14) * a66, 144);

                    apat_27 <= resize(ap(15) * a77, 144) + resize(ap(16) * a78, 144) + resize(ap(17) * a79, 144);

                    apat_28 <= resize(ap(15) * a87, 144) + resize(ap(16) * a88, 144) + resize(ap(17) * a89, 144);

                    apat_29 <= resize(ap(15) * a97, 144) + resize(ap(16) * a98, 144) + resize(ap(17) * a99, 144);

                    apat_33 <= resize(ap(18) * a31, 144) + resize(ap(19) * a32, 144) + resize(ap(20) * a33, 144);

                    apat_34 <= resize(ap(21) * a44, 144) + resize(ap(22) * a45, 144) + resize(ap(23) * a46, 144);

                    apat_35 <= resize(ap(21) * a54, 144) + resize(ap(22) * a55, 144) + resize(ap(23) * a56, 144);

                    apat_36 <= resize(ap(21) * a64, 144) + resize(ap(22) * a65, 144) + resize(ap(23) * a66, 144);

                    apat_37 <= resize(ap(24) * a77, 144) + resize(ap(25) * a78, 144) + resize(ap(26) * a79, 144);

                    apat_38 <= resize(ap(24) * a87, 144) + resize(ap(25) * a88, 144) + resize(ap(26) * a89, 144);

                    apat_39 <= resize(ap(24) * a97, 144) + resize(ap(25) * a98, 144) + resize(ap(26) * a99, 144);

                    apat_44 <= resize(ap(30) * a44, 144) + resize(ap(31) * a45, 144) + resize(ap(32) * a46, 144);

                    apat_45 <= resize(ap(30) * a54, 144) + resize(ap(31) * a55, 144) + resize(ap(32) * a56, 144);

                    apat_46 <= resize(ap(30) * a64, 144) + resize(ap(31) * a65, 144) + resize(ap(32) * a66, 144);

                    apat_47 <= resize(ap(33) * a77, 144) + resize(ap(34) * a78, 144) + resize(ap(35) * a79, 144);

                    apat_48 <= resize(ap(33) * a87, 144) + resize(ap(34) * a88, 144) + resize(ap(35) * a89, 144);

                    apat_49 <= resize(ap(33) * a97, 144) + resize(ap(34) * a98, 144) + resize(ap(35) * a99, 144);

                    apat_55 <= resize(ap(39) * a54, 144) + resize(ap(40) * a55, 144) + resize(ap(41) * a56, 144);

                    apat_56 <= resize(ap(39) * a64, 144) + resize(ap(40) * a65, 144) + resize(ap(41) * a66, 144);

                    apat_57 <= resize(ap(42) * a77, 144) + resize(ap(43) * a78, 144) + resize(ap(44) * a79, 144);

                    apat_58 <= resize(ap(42) * a87, 144) + resize(ap(43) * a88, 144) + resize(ap(44) * a89, 144);

                    apat_59 <= resize(ap(42) * a97, 144) + resize(ap(43) * a98, 144) + resize(ap(44) * a99, 144);

                    apat_66 <= resize(ap(48) * a64, 144) + resize(ap(49) * a65, 144) + resize(ap(50) * a66, 144);

                    apat_67 <= resize(ap(51) * a77, 144) + resize(ap(52) * a78, 144) + resize(ap(53) * a79, 144);

                    apat_68 <= resize(ap(51) * a87, 144) + resize(ap(52) * a88, 144) + resize(ap(53) * a89, 144);

                    apat_69 <= resize(ap(51) * a97, 144) + resize(ap(52) * a98, 144) + resize(ap(53) * a99, 144);

                    apat_77 <= resize(ap(60) * a77, 144) + resize(ap(61) * a78, 144) + resize(ap(62) * a79, 144);

                    apat_78 <= resize(ap(60) * a87, 144) + resize(ap(61) * a88, 144) + resize(ap(62) * a89, 144);

                    apat_79 <= resize(ap(60) * a97, 144) + resize(ap(61) * a98, 144) + resize(ap(62) * a99, 144);

                    apat_88 <= resize(ap(69) * a87, 144) + resize(ap(70) * a88, 144) + resize(ap(71) * a89, 144);

                    apat_89 <= resize(ap(69) * a97, 144) + resize(ap(70) * a98, 144) + resize(ap(71) * a99, 144);

                    apat_99 <= resize(ap(78) * a97, 144) + resize(ap(79) * a98, 144) + resize(ap(80) * a99, 144);
                ...
                when ADD_APAT_KRK =>
                    ...
                    p12_upd <= resize(shift_right(apat_12 + krk_12, 2*Q), 48);
                    p13_upd <= resize(shift_right(apat_13 + krk_13, 2*Q), 48);
                    p14_upd <= resize(shift_right(apat_14 + krk_14, 2*Q), 48);
                    p15_upd <= resize(shift_right(apat_15 + krk_15, 2*Q), 48);
                    p16_upd <= resize(shift_right(apat_16 + krk_16, 2*Q), 48);
                    p17_upd <= resize(shift_right(apat_17 + krk_17, 2*Q), 48);
                    p18_upd <= resize(shift_right(apat_18 + krk_18, 2*Q), 48);
                    p19_upd <= resize(shift_right(apat_19 + krk_19, 2*Q), 48);

                    p22_upd <= saturate_covariance(apat_22 + krk_22);
                    p23_upd <= resize(shift_right(apat_23 + krk_23, 2*Q), 48);
                    p24_upd <= resize(shift_right(apat_24 + krk_24, 2*Q), 48);
                    p25_upd <= resize(shift_right(apat_25 + krk_25, 2*Q), 48);
                    p26_upd <= resize(shift_right(apat_26 + krk_26, 2*Q), 48);
                    p27_upd <= resize(shift_right(apat_27 + krk_27, 2*Q), 48);
                    p28_upd <= resize(shift_right(apat_28 + krk_28, 2*Q), 48);
                    p29_upd <= resize(shift_right(apat_29 + krk_29, 2*Q), 48);

                    p33_upd <= saturate_covariance(apat_33 + krk_33);
                    p34_upd <= resize(shift_right(apat_34 + krk_34, 2*Q), 48);
                    p35_upd <= resize(shift_right(apat_35 + krk_35, 2*Q), 48);
                    p36_upd <= resize(shift_right(apat_36 + krk_36, 2*Q), 48);
                    p37_upd <= resize(shift_right(apat_37 + krk_37, 2*Q), 48);
                    p38_upd <= resize(shift_right(apat_38 + krk_38, 2*Q), 48);
                    p39_upd <= resize(shift_right(apat_39 + krk_39, 2*Q), 48);

                    p44_upd <= saturate_covariance(apat_44 + krk_44);
                    p45_upd <= resize(shift_right(apat_45 + krk_45, 2*Q), 48);
                    p46_upd <= resize(shift_right(apat_46 + krk_46, 2*Q), 48);
                    p47_upd <= resize(shift_right(apat_47 + krk_47, 2*Q), 48);
                    p48_upd <= resize(shift_right(apat_48 + krk_48, 2*Q), 48);
                    p49_upd <= resize(shift_right(apat_49 + krk_49, 2*Q), 48);

                    p55_upd <= saturate_covariance(apat_55 + krk_55);
                    p56_upd <= resize(shift_right(apat_56 + krk_56, 2*Q), 48);
                    p57_upd <= resize(shift_right(apat_57 + krk_57, 2*Q), 48);
                    p58_upd <= resize(shift_right(apat_58 + krk_58, 2*Q), 48);
                    p59_upd <= resize(shift_right(apat_59 + krk_59, 2*Q), 48);

                    p66_upd <= saturate_covariance(apat_66 + krk_66);
                    p67_upd <= resize(shift_right(apat_67 + krk_67, 2*Q), 48);
                    p68_upd <= resize(shift_right(apat_68 + krk_68, 2*Q), 48);
                    p69_upd <= resize(shift_right(apat_69 + krk_69, 2*Q), 48);

                    p77_upd <= saturate_covariance(apat_77 + krk_77);
                    p78_upd <= resize(shift_right(apat_78 + krk_78, 2*Q), 48);
                    p79_upd <= resize(shift_right(apat_79 + krk_79, 2*Q), 48);

                    p88_upd <= saturate_covariance(apat_88 + krk_88);
                    p89_upd <= resize(shift_right(apat_89 + krk_89, 2*Q), 48);
