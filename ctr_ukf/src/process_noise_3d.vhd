...
architecture Behavioral of process_noise_3d is
    ...
    constant Q22_Q24_24 : signed(47 downto 0) := to_signed(16777, 48);
    constant Q33_Q24_24 : signed(47 downto 0) := to_signed(16777, 48);

    constant Q44_Q24_24 : signed(47 downto 0) := to_signed(838861, 48);
    constant Q55_Q24_24 : signed(47 downto 0) := to_signed(16777, 48);
    constant Q66_Q24_24 : signed(47 downto 0) := to_signed(16777, 48);

    constant Q77_Q24_24 : signed(47 downto 0) := to_signed(838861, 48);
    constant Q88_Q24_24 : signed(47 downto 0) := to_signed(16777, 48);
    constant Q99_Q24_24 : signed(47 downto 0) := to_signed(16777, 48);
            ...
            case state is
                ...
                when ADD_NOISE =>
                    ...
                    report "PROCESS_NOISE: ADD_NOISE state" & LF &
                           ...
                           "  p33_in=" & integer'image(to_integer(p33_in)) & LF &
                           "  Q11=" & integer'image(to_integer(Q11_Q24_24)) & LF &
                           "  Q33=" & integer'image(to_integer(Q33_Q24_24));
                ...
                when SATURATE =>
                    ...
                    report "PROCESS_NOISE: SATURATE state" & LF &
                           "  sum_p11=" & integer'image(to_integer(sum_p11(47 downto 16))) & LF &
                           "  sum_p22=" & integer'image(to_integer(sum_p22(47 downto 16))) & LF &
                           "  sum_p33=" & integer'image(to_integer(sum_p33(47 downto 16)));
