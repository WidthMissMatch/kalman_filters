...
architecture Behavioral of predicted_covariance_7d is
  ...
  signal acc11, acc12, acc13, acc14, acc15, acc16, acc17 : signed(48 downto 0);
  signal acc22, acc23, acc24, acc25, acc26, acc27 : signed(48 downto 0);
  signal acc33, acc34, acc35, acc36, acc37 : signed(48 downto 0);
  signal acc44, acc45, acc46, acc47 : signed(48 downto 0);
  signal acc55, acc56, acc57 : signed(48 downto 0);
  signal acc66, acc67 : signed(48 downto 0);
  signal acc77 : signed(48 downto 0);
