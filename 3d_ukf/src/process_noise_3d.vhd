...
architecture Behavioral of process_noise_3d is
    ...
    constant Q11_Q24_24 : signed(47 downto 0) := to_signed(83886080, 48);
    ...
    constant Q22_Q24_24 : signed(47 downto 0) := to_signed(4194304, 48);
    ...
    constant Q33_Q24_24 : signed(47 downto 0) := to_signed(83886080, 48);
    ...
    constant Q44_Q24_24 : signed(47 downto 0) := to_signed(4194304, 48);
    constant Q45_Q16_16 : signed(47 downto 0) := to_signed(0, 48);
    constant Q46_Q16_16 : signed(47 downto 0) := to_signed(0, 48);

    constant Q55_Q24_24 : signed(47 downto 0) := to_signed(83886080, 48);
    constant Q56_Q16_16 : signed(47 downto 0) := to_signed(0, 48);

    constant Q66_Q24_24 : signed(47 downto 0) := to_signed(4194304, 48);
