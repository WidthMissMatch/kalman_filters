...
architecture Behavioral of innovation_3d is
    ...
    signal diff_x : signed(32 downto 0);
    signal diff_y : signed(32 downto 0);
    signal diff_z : signed(32 downto 0);
        ...
        if rising_edge(clk) then
            case state is
                ...
                when COMPUTE =>
                    ...
                    diff_x <= resize(z_x_meas, 33) - resize(z_x_mean, 33);
                    diff_y <= resize(z_y_meas, 33) - resize(z_y_mean, 33);
                    diff_z <= resize(z_z_meas, 33) - resize(z_z_mean, 33);
